...
import os
import sys
from utils.PyLib.utils import makefolders
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--data_dir', type=str,
                            default='./dataset/', help='path to images')
        parser.add_argument('--pretrain_path', type=str,
                            default='./sgPretainedModel/', help='pretrained model path')
        ...
        parser.add_argument('--exper_name', type=str, default='logs_out', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--mode', type=str, default='train', help='select the mode train or test')
